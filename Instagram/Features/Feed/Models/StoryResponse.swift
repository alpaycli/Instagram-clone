...
struct StoryModel: Codable {
   ...
   static let mockData: [Self] = [
      ...
      .init(),
      .init(username: "cristianoneblimne", storyUrl: "https://picsum.photos/seed/baku1/720/1280"),
      .init(username: "crsanoneblimne", storyUrl: "https://picsum.photos/seed/baku1/720/1280"),
      .init(username: "rsanoneblimn", storyUrl: "https://picsum.photos/seed/baku1/720/1280"),
      .init(),
      .init(),
      .init(),
      .init(),
